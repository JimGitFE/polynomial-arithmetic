...
declare const utils: {
    ...
    polyReformat: (poly: import("./types").PolynomialParameters[keyof import("./types").PolynomialParameters], formatType?: import("./types/enums").polyFormats) => [polyString, polyCoefficients, polyExponents];
    gcd: ({ r0, r1 }: {
        r0: number;
        r1: number;
    }) => number;
