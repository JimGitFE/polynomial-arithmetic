 ...
 * @internal
*/
function coefToString (coefs: polyFormats["coefficients"]): polyFormats['string'] {
    // handle neutral
 ...
 * @internal
 */
const stringToCoef = (polyStr: polyFormats['string']): polyFormats["coefficients"] => {
 ...
 * @internal
*/
const expToCoef = (exponentArr: polyFormats["exponents"]): polyFormats["coefficients"] => {
 ...
 * @internal
*/
const coefToExp = (coefArr: polyFormats["coefficients"]): polyFormats["exponents"] => {
 ...
 * @public
 */
const polyReformat = (poly: PolynomialParameters[keyof PolynomialParameters], formatType?: keyof polyFormats ): [polyFormats['string'], polyFormats["coefficients"], polyFormats["exponents"]] => {
    ...
    if (poly instanceof Polynomial || isFieldPolynomial(poly)) {
        ...
        return [<polyFormats['string']>poly, stringToCoef(<polyFormats['string']>poly), coefToExp(<(0 | 1|-1)[]>stringToCoef(<polyFormats['string']>poly)) ]
        
        // Coefficient Array Representation // [1,1,1,0,1,1,0,0,1,1]
    } else if (formatType?formatType === "coefficients": true) {
        return [coefToString(<polyFormats["coefficients"]>poly), <polyFormats["coefficients"]>poly, coefToExp(<polyFormats["coefficients"]>poly) ]
        ...
        return [coefToString(expToCoef(<polyFormats["exponents"]>poly)), expToCoef(<polyFormats["exponents"]>poly), <polyFormats["exponents"]>poly ]
